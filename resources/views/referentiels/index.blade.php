                ...
                <div class="-mx-4 -my-2 overflow-x-auto overflow-auto sm:-mx-6 lg:-mx-8">
                    <div class="flex justify-end gap-3 px-1 lg:px-4">
                        ...
                        <span class="mb-4 pb-5 p-1">
                            <a href="{{ route('referentiels.create') }}" title="Créer ici..">
                                ...
                                @forelse ($datas as $data)
                                    <tr class="hover:bg-color_rej">
                                        ...
                                        <td class="px-3 py-2 text-sm whitespace-nowrap flex items-center justify-start">
                                            ...
                                            <a href="{{ route('referentiels.destroy', $data?->id) }}" title="Supprimer" class="font-light hover:underliner">
                                                <form method="post" action="{{route('referentiels.destroy', $data?->id)}}" enctype="multipart/form-data">
                                                    @csrf
                                                    @method("DELETE")
