...
<html x-data="main" class :class="[$store.app.mode]">
        ...
        <header>
            <nav class="bg-lightwhite dark:bg-black px-4 lg:px-7 py-4">
                <div class="flex flex-wrap justify-between items-center">
                    <a href="{{route('portail')}}" class="flex items-center w-auto">
                        <x-application-logo />
                    </a>
                    <div class="flex items-center lg:order-2">
                        <div class="mr-2">
                            ...
                            <a href="javascript:;" class="text-black dark:text-white" x-cloak x-show="$store.app.mode === 'dark'" @click="$store.app.toggleMode('light')">
                                <svg class="w-5 h-5" width="32" height="32" viewbox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <path d="M15 27.5V30C15 30.5523 15.4477 31 16 31C&16.5523 31 17 30.5523 17 30V27.5C17 26.9477 16.5523 26.5 16 26.5C15.4477 26.5 15 26.9477 15 27.5Z" fill="currentColor" />
                        ...
                        <a href="#!" class="text-black dark:text-white border border-transparent hover:border-black/10 dark:hover:border-white rounded-lg text-sm px-2 py-1 mr-2 transition-all duration-300">
                            S'enroller
                        </a>
                        <a href="#!" class="text-black dark:text-white border border-transparent hover:border-black/10 dark:hover:border-white rounded-lg text-sm px-2 py-1 mr-2 transition-all duration-300">
                            Voter
                        </a>
                        <a href="{{route('login')}}" class="text-white border border-black/10 hover:bg-transparent hover:text-black bg-black dark:text-black dark:bg-white dark:border-white dark:hover:bg-transparent dark:hover:text-white rounded-lg text-sm px-2 py-1 mr-2 transition-all duration-300">
                            Se connecter
                        </a>
                    </div>
                </div>
    ...
    <div class="text-center sm:flex-none">
        <h2 class="text-2xl font-semibold mb-10">Le portail web <span class="font-bold">Clean Election</span> est en cours de construction ! </h2>
        <img src="{{asset('assets/images/maintanence.svg')}}" class="mb-10 mx-auto dark:hidden" alt="images" />
        <img src="{{asset('assets/images/maintanence-dark.svg')}}" class="mb-10 mx-auto hidden dark:block" alt="images" />
        <p class="text-black/40 dark:text-white/40">Vous avez besoin d'aide ?</p>
        <a href="javascritp:;" class="text-lightpurple-300"><span class="__cf_email__" data-cfemail="2a444507584f5a46536a4e45474b434404494547">[contact@cleanelection.ga]</span></a>
    </div>
</div>

        <footer class="p-7 flex items-center justify-center">
            <p class="text-xs text-black/40 dark:text-white/40">&copy; 2023 Clean-Election</p>
        </footer>

        <script data-cfasync="false" src="../cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js"></script><script src="assets/js/alpine-collaspe.min.js"></script>
