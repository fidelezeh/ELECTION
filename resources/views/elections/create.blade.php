                ...
                <form action="{{route('election.store')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 gap-4">
                        ...
                        <div class="pt-4">
                            ...
                            <div class="relative mt-1">
                                <input type="date" name="session_election" id="session_election" required value="{{ old('session_election') }}" class="peer block w-full border-0 bg-gray-50 py-0.5 text-gray-900 focus:ring-0 sm:text-sm sm:leading-6">
                        ...
                        @forelse  ($lestatuts as $v)
                            <input type="hidden" name="statut_election_id" id="statut_election_id" required value="{{ $v?->id }}" class="peer block w-full border-0 bg-gray-50 py-0.5 text-gray-900 focus:ring-0 sm:text-sm sm:leading-6">
                        @empty
                        @endforelse
                        <div class="pt-4">
                            <label for="date_d_verif_list" class="block text-sm font-medium leading-6 text-gray-900">Début vérification des listes</label>
                            <div class="relative mt-1">
                                <input type="date" name="date_d_verif_list" id="date_d_verif_list" value="{{ old('date_d_verif_list') }}" class="peer block w-full border-0 bg-gray-50 py-0.5 text-gray-900 focus:ring-0 sm:text-sm sm:leading-6">
                        ...
                        <div class="pt-4">
                            ...
                            <div class="relative mt-1">
                                <input type="date" name="date_f_verif_list" id="date_f_verif_list" value="{{ old('date_f_verif_list') }}" class="peer block w-full border-0 bg-gray-50 py-0.5 text-gray-900 focus:ring-0 sm:text-sm sm:leading-6">
                        ...
                        <div class="pt-4">
                            ...
                            <div class="relative mt-1">
                                <input type="date" name="date_d_campagne" id="date_d_campagne" value="{{ old('date_d_campagne') }}" class="peer block w-full border-0 bg-gray-50 py-0.5 text-gray-900 focus:ring-0 sm:text-sm sm:leading-6">
                        ...
                        <div class="pt-4">
                            ...
                            <div class="relative mt-1">
                                <input type="date" name="date_f_campagne" id="date_f_campagne" value="{{ old('date_f_campagne') }}" class="peer block w-full border-0 bg-gray-50 py-0.5 text-gray-900 focus:ring-0 sm:text-sm sm:leading-6">
                        ...
                        <div class="pt-4">
                            ...
                            <div class="relative mt-1">
                                <input type="date" name="date_d_vote" id="date_d_vote" value="{{ old('date_d_vote') }}" class="peer block w-full border-0 bg-gray-50 py-0.5 text-gray-900 focus:ring-0 sm:text-sm sm:leading-6">
                                @error('date_d_vote')
                                <div class="text-red-500 text-sm">{{$message}}</div>
                                @enderror
                                <div class="absolute inset-x-0 bottom-0 border-t border-ventis_color peer-focus:border-t-2 peer-focus:border-color_att" aria-hidden="true"></div>
                        ...
                        <div class="pt-4">
                            ...
                            <div class="relative mt-1">
                                <input type="date" name="date_f_vote" id="date_f_vote" value="{{ old('date_f_vote') }}" class="peer block w-full border-0 bg-gray-50 py-0.5 text-gray-900 focus:ring-0 sm:text-sm sm:leading-6">
                                @error('date_f_vote')
                                <div class="text-red-500 text-sm">{{$message}}</div>
                                @enderror
                                <div class="absolute inset-x-0 bottom-0 border-t border-ventis_color peer-focus:border-t-2 peer-focus:border-color_att" aria-hidden="true"></div>
